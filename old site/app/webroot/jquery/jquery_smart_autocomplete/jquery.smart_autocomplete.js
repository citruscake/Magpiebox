  ...
  $.fn.smartAutoComplete = function(){    
    ...
    var default_options = {
                            ...
                            resultFormatter: function(r){ 
								return (
									"<li class=\"smart_autocomplete_container\" style=\"list-style: none; cursor: pointer;padding:5px;width:395px;background-color: #ffffff;border-color:#eeeeee;border-style:solid;border-width:0px 1px 1px 1px;color:#333333;color:#333333;\">" + r + "</li>"
			/*"list-style": "none","cursor": "pointer","margin-left": "-40px","padding": "5px","width":"158px","background-color": "#dddddd","border-color":"#eeeeee","border-style":"solid","border-width":"0px 1px 1px 1px","color":"#333333"*/
    ...
    $.event.special.itemFocus = {
      ...
      _default: function(ev){    
		...
		//me
		$(item).removeClass("smart_autocomplete_container");
    ...
    $.event.special.itemUnfocus = { 
      ...
      _default: function(ev){    
		...
		//me
		$(item).addClass("smart_autocomplete_container");
    ...
    return this.each(function(i) { 
      ...
      if($.type(options.resultsContainer) === "undefined" ){
        ...
        var default_container = $("<ul class='smart_autocomplete_container' style='display:none;margin-top:10px;'></ul>");
      ...
      $(this).on("keydown", function(ev){
        ...
        //else if(ev.keyCode === 39 || ev.keyCode === 13){
          ...
          if(options.resultsContainer && $(options.resultsContainer).is(':visible')){
			...
			//console.log("result suggestion "+result_suggestions);
			//exit();
			if(current_selection!==undefined) {//I added this
          ...
          return false;
			...
			//$(options.context).trigger("itemSelect", [ result_suggestions[options.currentSelection] ] );
			//return false; //I did this
		}
        else {
