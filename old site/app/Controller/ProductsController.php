...
class ProductsController extends AppController {
	...
	//exit();
		$this->layout = "shop_main";
		$this->set('custom_title', "Products");
	...
	//	var_dump($this->params);
		//$link = mysql_connect('cust-mysql-123-14', 'mb_db', 'XW!GRchTW');
		...
		if (isset($category_id)) {
			...
			$this->set('products', $products);
			//$category = $this->Category->find('first', array('conditions' => array('Category.category_id' => $category_id)));
	...
	public function getCategories() {
		...
		//if(isset($this->params['requested'])) {
			...
			return $this->Category->find('all', array('order' => array('Category.category_id DESC')));
	...
	public function beforeFilter() {
		...
		if($this->Session->check('Auth.User')) {
			$this->set('user', $this->Session->read('Auth.User')['User']);
		}
	}	
}
