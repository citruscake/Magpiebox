...
?>
	<li class="mb_thumbnail_width">
		<div class="thumbnail" style="height:270px;">
				...
				<?php echo $this->Html->image($product['Product']['thumbnail_url'], array('alt' => $product['Product']['name'], 'width'=>'100%', 'url'=>array('controller'=>'products', 'action'=>'view',  $product['Product']['product_id']))); ?>
					</div>
					<div class="caption">
					<div class="row">
